...
namespace ToDoApp.Controllers
{
    public class TasksController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TaskID,DueDate,TaskName,TaskDone")] Task task)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TaskID,DueDate,TaskName,TaskDone")] Task task)
        {
            if (ModelState.IsValid)
            {
